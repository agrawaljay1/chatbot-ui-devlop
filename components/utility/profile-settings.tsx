...
export const ProfileSettings: FC<ProfileSettingsProps> = ({}) => {
  ...
  const [labelboxAPIKey, setLabelboxAPIKey] = useState(
    profile?.labelbox_api_key || ""
  )
        ...
        <div className="grow overflow-auto">
          ...
          <Tabs defaultValue="profile">
            ...
            <TabsContent className="mt-4 space-y-4" value="keys">
              ...
              <div className="space-y-1">
                {envKeyMap["labelbox"] ? (
                  <Label>Labelbox API key set by admin.</Label>
                ) : (
                  <>
                    <Label>Labelbox API Key</Label>
                    <Input
                      placeholder="Labelbox API Key"
                      type="password"
                      value={labelboxAPIKey}
                      onChange={e => setLabelboxAPIKey(e.target.value)}
                    />
                  </>
                )}
              </div>
